...
function ChevronDownIcon({ className }: { className: string }) {
  return <span aria-hidden="true" className={`${className} bazi-icon-glyph bazi-chevron-glyph`} />;
}
...
export function NativeSelect({
  ...
  return (
    <div className="bazi-native-select-wrap">
      ...
      <ChevronDownIcon className="bazi-select-chevron bazi-select-chevron-mobile" />
      ...
      <div ref={rootRef} className="bazi-custom-select-desktop">
        ...
        >
          ...
          <ChevronDownIcon className="bazi-select-chevron bazi-select-chevron-desktop" />
        </button>
